...
from graphrag.Core.Common.Constants import USE_CONFIG_TIMEOUT
from graphrag.Core.Common.Logger import log_llm_stream, logger
from graphrag.Core.Provider.BaseLLM import BaseLLM
from graphrag.Core.Provider.LLMProviderRegister import register_provider
from graphrag.Core.Common.Utils import  log_and_reraise,prase_json_from_response
from graphrag.Core.Common.CostManager import CostManager
from graphrag.Core.Utils.Exceptions import handle_exception
from graphrag.Core.Utils.TokenCounter import (
    count_input_tokens,
    count_output_tokens,
...
class OpenAILLM(BaseLLM):
    ...
    def _cons_kwargs(self, messages: list[dict], timeout=USE_CONFIG_TIMEOUT, max_tokens = None, **extra_kwargs) -> dict:
        ...
        if 'qwen3' in self.model.lower():
            ...
            kwargs["extra_body"]["chat_template_kwargs"].setdefault("enable_thinking", False)
