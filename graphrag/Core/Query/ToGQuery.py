...
from graphrag.Core.Common.Utils import list_to_quoted_csv_string, truncate_list_by_token_size, combine_contexts
...
class ToGQuery(BaseQuery):
    ...
    async def _retrieve_relevant_contexts(self, query: str, mode: str) -> str:
        if mode == "retrieve":
            ...
            if flag:
                from graphrag.Core.Prompt.TogPrompt import prompt_evaluate
            ...
            from graphrag.Core.Prompt.TogPrompt import answer_prompt
