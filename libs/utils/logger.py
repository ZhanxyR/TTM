# https://github.com/modelscope/evalscope/evalscope/utils/logger.py
...
def get_logger(log_file: Optional[str] = None, log_level: int = DEFAULT_LEVEL, file_mode: str = 'w', force=False, logger_name: str = __name__.split('.')[0]):
    """Get logging logger
