...
from graphrag.Config.EmbConfig import EmbeddingType
from graphrag.Config.LLMConfig import LLMType
from graphrag.Core.Common.BaseFactory import GenericFactory
...
class RAGEmbeddingFactory(GenericFactory):
    ...
    def __init__(self):
        creators = {
            ...
            # EmbeddingType.LOCAL: self._create_local,
        }
    ...
    # def _create_local(self, config) -> BaseEmbedding:
